...
#ifndef ALICEO2_FCT_TrackFitter_H_
#define ALICEO2_FCT_TrackFitter_H_
...
class TrackFitter
{
 ...
 public:
  ...
  bool initTrack(FCTTrack& track, bool outward = false);
  bool fit(FCTTrack& track, bool outward = false);
  void MinuitFit(FCTTrack& track);
 ...
 private:
  bool computeCluster(FCTTrack& track, int cluster);
...
Double_t invQPtFromFCF(const FCTTrack& track, Double_t bFieldZ, Double_t& chi2);
...
#endif // ALICEO2_FCT_TrackFitter_H_
